...
class DataDealSeq(object):
    ...
    def get_dev(self):
        ...
        for sentence in train_sentcens:
            ...
            label=sentences[2]
            Q_array=self.sent2array(Q_sentence,self.content_len)
            A_array=self.sent2array(A_sentence,self.title_len)
    ...
    def get_test(self):
        ...
        for sentence in train_sentcens:
            ...
            A_array,_=self.sent2array(A_sentence,self.title_len)
...
if __name__ == '__main__':
    ...
    dd = DataDealSeq(train_path="/baidu_zd_500.txt", test_path="/test.txt",
                            dev_path="/dev1.txt",
                            dim=100, batch_size=64 ,content_len=20, title_len=15, flag="train_new")

    print(dd.get_vocab_size())

    return_content_input,return_content_decoder, return_title, return_content_len, return_title_len,loss = dd.next_batch()
    for e,e1 in zip(return_content_input,return_content_decoder):
        print(e,e1)
    print(loss)
